...
{
    [Binding]
    public sealed class Tushar_Dhage_Add_User_StepDefinitions
    {
        private IWebDriver driver;
        TusharDhage_UserManagement userManagement;


        public Tushar_Dhage_Add_User_StepDefinitions(IWebDriver driver)
        {
            this.driver = driver;
            userManagement = new TusharDhage_UserManagement(driver);
        }
